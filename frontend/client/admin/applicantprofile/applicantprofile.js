...
// Add this function to fetch applicant profile picture
async function loadApplicantProfilePic(applicantId) {
  try {
    const response = await fetch(`${API_BASE_URL}/api/admin/applicants/${applicantId}/profile-pic`, {
      credentials: 'include'
    });
    ...
    console.error("Error loading applicant profile picture:", error);
    return null;
  }
}
...
async function loadApplicantData(applicantId) {
    try {
        ...
        const profilePicUrl = await loadApplicantProfilePic(applicantId) || 
            generateInitialsAvatar(applicant.personalInfo?.firstname, applicant.personalInfo?.lastname);
        
        // Update profile picture container
        const profilePicContainer = document.querySelector('.profile-pic-container');
        profilePicContainer.innerHTML = `
            <img src="${profilePicUrl}" alt="Profile Picture" class="profile-pic-img">
        `;
        
        // Populate basic info
        document.getElementById('profile-name').textContent = 
            formatFullName(applicant.personalInfo);
        document.getElementById('profile-occupation').textContent = 
            applicant.personalInfo?.occupation || 'Not specified';
        document.getElementById('profile-email').textContent = 
            applicant.personalInfo?.emailAddress || applicant.email || 'N/A';
        document.getElementById('applicantId').textContent = 
            applicant.applicantId || 'Not assigned';
        
        // Populate personal information
        document.getElementById('profile-gender').textContent = 
            applicant.personalInfo?.gender || 'N/A';
        document.getElementById('profile-age').textContent = 
            applicant.personalInfo?.age || 'N/A';
        document.getElementById('profile-nationality').textContent = 
            applicant.personalInfo?.nationality || 'N/A';
        document.getElementById('profile-civil-status').textContent = 
            applicant.personalInfo?.civilstatus || 'N/A';
        document.getElementById('profile-birthdate').textContent = 
            formatDate(applicant.personalInfo?.birthDate) || 'N/A';
        document.getElementById('profile-birthplace').textContent = 
            applicant.personalInfo?.birthplace || 'N/A';
        
        // Populate contact information
        document.getElementById('profile-phone').textContent = 
            applicant.personalInfo?.mobileNumber || 'N/A';
        document.getElementById('profile-telephone').textContent = 
            applicant.personalInfo?.telephoneNumber || 'N/A';
        
        // Populate address information
        document.getElementById('profile-country').textContent = 
            applicant.personalInfo?.country || 'N/A';
        document.getElementById('profile-province').textContent = 
            applicant.personalInfo?.province || 'N/A';
        document.getElementById('profile-city').textContent = 
            applicant.personalInfo?.city || 'N/A';
        document.getElementById('profile-street').textContent = 
            applicant.personalInfo?.street || 'N/A';
        document.getElementById('profile-zip').textContent = 
            applicant.personalInfo?.zipCode || 'N/A';
        
        // Populate course priorities
        document.getElementById('profile-first-priority').textContent = 
            applicant.personalInfo?.firstPriorityCourse || 'N/A';
        document.getElementById('profile-second-priority').textContent = 
            applicant.personalInfo?.secondPriorityCourse || 'N/A';
        document.getElementById('profile-third-priority').textContent = 
            applicant.personalInfo?.thirdPriorityCourse || 'N/A';
        
        // Set application status
        updateStatusBadge(applicant.status);
        document.getElementById('createdAt').textContent = 
            formatDate(applicant.createdAt) || 'N/A';
